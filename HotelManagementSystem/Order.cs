...
namespace HotelManagementSystem
{
    public partial class Order : Form
    {
        ...
        private void PopulateGridView(string sql = "select * from OrderItem order by orderid")
        {
        ...
        private void btnOrderUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    var query = "select * from OrderItem where OrderName = '" + name + "'";
        ...
        private void txtOrderSearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                string search = "select * from OrderItem where OrderName = '" + this.txtOrderSearch.Text + "'";
        ...
        {
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        var sql = @"insert into OrderItem values('" + this.newID + "', '" + this.txtOrderName.Text + "')";
        ...
        private void btnOrderDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var sql = "delete from OrderItem where OrderName = '" + name + "'";
        ...
        private void GenerateID()
        {
            try
            {
                var sql = @"select OrderID from OrderItem Order by OrderID DESC";
                var ds = this.Da.ExecuteQuery(sql);
