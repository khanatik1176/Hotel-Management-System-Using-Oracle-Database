...
namespace HotelManagementSystem
{
    public partial class FoodItem : Form
    {
        ...
        private void PopulateGridView(string sql = "select * from FoodItem")
        {
        ...
        private void btnFoodItemAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    var sql = @"insert into FoodItem values('" + this.txtFoodBarCode.Text + "','" + this.txtfoodName.Text + "')";
        ...
        private void btnFoodItemDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var sql = "delete from FoodItem where ItemName = '" + name + "'";
        ...
        private void btnfooditemupdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    var query = "select * from FoodItem where ItemName = '" + name + "'";
        ...
        private void txtFooditemSearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                string search = "select * from FoodItem where ItemName = '" + this.txtFooditemSearch.Text + "'";
        ...
        private void btnEnable_Click(object sender, EventArgs e)
        {
                ...
                var query = "Alter trigger check_barcode enable";
        ...
        {
            var query = "Alter trigger check_barcode disable";
            this.Da.ExecuteQuery(query);
