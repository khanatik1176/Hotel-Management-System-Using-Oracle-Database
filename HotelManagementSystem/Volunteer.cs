...
namespace HotelManagementSystem
{
    public partial class Volunteer : Form
    {
        ...
        private void PopulateGridView(string sql = "select * from Volunteer order by volunteerid")
        {
        ...
        private void btnVolunteerAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var sql = @"insert into Volunteer values('" + this.newID + "', '" + this.txtVolunteerName.Text + "',  '" + this.txtVolunteerAddress.Text + "', '" + this.txtVolunteerPhone.Text + "')";
        ...
        private void btnVolunteerDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var sql = "delete from Volunteer where VolunteerID = '" + id + "'";
        ...
        private void btnVolunteerUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    var query = "select * from Volunteer where VolunteerID = '" + id + "'";
        ...
        private void txtVolunteerSearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                string search = "select * from Volunteer where VolunteerName = '" + this.txtVolunteerSearch.Text + "'";
        ...
        private void GenerateID()
        {
            try
            {
                var sql = @"select VolunteerID from Volunteer Order by VolunteerID DESC";
                var ds = this.Da.ExecuteQuery(sql);
        ...
        {
            var query = "Alter trigger check_phone_number enable";
        ...
        {
            var query = "Alter trigger check_phone_number disable";
            this.Da.ExecuteQuery(query);
