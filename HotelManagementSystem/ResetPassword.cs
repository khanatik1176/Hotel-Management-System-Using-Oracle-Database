...

    {
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    var query = "select * from LoginInfo where UserID = '" + this.txtResetUsername.Text + "'";
                    ...
                    if (dst.Tables[0].Rows.Count == 1)
                    {
                        ...
                        var kt = @"update LoginInfo
                                set UserPassword = '" + this.txtNewPassword.Text + @"'    
                                where UserID = '" + this.txtResetUsername.Text + "'";
